...
public class PersonController {
	...
	//@CrossOrigin(origins= "http://localhost:8080") CORS somente em determinado metodo
	...
	//@CrossOrigin(origins= {"http://localhost:8080", "http://www.erudio.com.br"}) CORS somente em determinado metodo
