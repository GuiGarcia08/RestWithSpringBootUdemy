...
public class PersonController {
	...
	// @CrossOrigin(origins= "http://localhost:8080") CORS somente em determinado
	// metodo
	@Operation(summary = "Find specific Person by your ID")
	...
	// CORS somente em determinado metodo
